...
<script type="text/javascript">
  ...
  <div class="span12 margin-l20">
    <a href="index.php?pg=edit_cidades&acao=publicar" class="btn btn-success pull-left">ADD CIDADES</a>
  </div>  
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon">
            <input type="checkbox" id="seleccheckbox" name="seleccheckbox" id="title-checkbox" />
            </span>
            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td class="center">
                    <a href="index.php?pg=view_cidades&acao=deletar&codigo=<?php echo $value->codigo;?>" onclick="return confirmaExclusao();"><span class="btn btn-mini btn-danger">Deletar</span></a>
                    <a href="index.php?pg=edit_cidades&acao=editar&codigo=<?php echo $value->codigo;?>"><span class="btn btn-mini btn-primary">Editar</span></a>
                    <a href="index.php?pg=view_bairros&acao=publicar&codcid=<?php echo $value->codigo;?>"><span class="btn btn-mini btn-primary">Add Bairros</span></a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
        ...
        <div class="span12">
          <div class="row">
            ...
            <div class="span7" <?php echo ($total<=$max ? 'style="display:none;"':""); ?>>
              <div class="pagination dataTables_paginate paging_simple_numbers" id="datatable-keytable_paginate">
                <ul class="pagination">
                    <?php $menos=$p-1;
                    $mais= $p+1;
                    $quant_pg=ceil($total/$max);
                    if($menos>=0) { ?><li class="paginate_button"><a href="index.php?pg=<?php echo $urlReturn; ?>&p=<?php echo $mais; ?>&tipo=<?php echo $tipo; ?>&cod_tabla=<?php echo $cod_tabla; ?>&tabela=<?php echo $tabela; ?>&usuario=<?php echo $usuario; ?>" title="Voltar uma Página!">«</a></li><?php }
                    $anterior  = (($p-4)<1 ? 0 : $p-4);
                    $posterior = (($p+4)>$quant_pg ? $quant_pg-1 : $p+3);
                    for($i=$anterior; $i<=$posterior; $i++) {
                      if($i!=$p) { ?>
                        <li class="paginate_button"><a href="index.php?pg=<?php echo $urlReturn; ?>&p=<?php echo $i; ?>&tipo=<?php echo $tipo; ?>&cod_tabla=<?php echo $cod_tabla; ?>&tabela=<?php echo $tabela; ?>&usuario=<?php echo $usuario; ?>" title="Ir para a página <?php echo ($i<10 && $i<>0 ? "0".($i) : ($i==0 ? "Inicial" : $i+1)); ?>!"><?php echo ($i<10 && $i<>0 ? "0".($i) : ($i==0 ? "Inicial" : $i+1)); ?></a></li>
                      <?php } else { ?>
                    ...
                    if($mais<$quant_pg) { ?><li class="paginate_button "><a href="index.php?pg=<?php echo $urlReturn; ?>&p=<?php echo $mais; ?>&tipo=<?php echo $tipo; ?>&cod_tabla=<?php echo $cod_tabla; ?>&tabela=<?php echo $tabela; ?>&usuario=<?php echo $usuario; ?>" title="Avançar uma Página!">»</a></li><?php } ?>
                </ul>
              </div>
            </div>
          </div>
