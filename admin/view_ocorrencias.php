...
<script type="text/javascript">
  ...
  <div class="span12 margin-l20">
    <a href="index.php?pg=edit_ocorrencias&acao=publicar" class="btn btn-success pull-left">ADD ocorrencias</a>
  </div>  
            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td class="center">
                    <a href="index.php?pg=view_ocorrencias&acao=deletar&codigo=<?php echo $value->codigo;?>" onclick="return confirmaExclusao();"><span class="btn btn-mini btn-danger">Deletar</span></a>
                    <a href="index.php?pg=edit_ocorrencias&acao=editar&codigo=<?php echo $value->codigo;?>"><span class="btn btn-mini btn-primary">Editar</span></a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
